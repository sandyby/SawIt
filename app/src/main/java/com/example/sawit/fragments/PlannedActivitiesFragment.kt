        ...
        adapter = ActivitiesAdapter(
            ...
            onDeleteClicked = { activity ->
                val dialog = MaterialAlertDialogBuilder(
                    ...
                    .setMessage("Are you sure you want to delete the planned task ${activity.activityType} on field ${activity.fieldName}?")
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            repeatOnLifecycle(Lifecycle.State.STARTED) {
                combine(
                    ...
                    val planned = updatedActivities.filter { it.status == "planned" }
